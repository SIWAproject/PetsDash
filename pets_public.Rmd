...
ggplot(df_agg,
       aes(x = Timepoint,
           y = Abundance,
           fill = Genus,)) +  geom_bar(stat = "identity", position = "fill") +  scale_fill_cvi_d("cvi_siwa") + theme(axis.text.x = element_text(angle = 60, hjust = 1)) + facet_wrap( ~Group, scales = 'free', nrow=1,ncol=4)
...
```{r plot1,warning=FALSE, echo=FALSE, results = F}
