...
![perro](perro.jpg){#id .class width=50% height=80% position="center"}

```{r picture, echo=FALSE, include=FALSE}
...
Ganoderma Project {data-icon="fa-table"}
===================================== 
...
```{r , echo=FALSE, include=FALSE, warning=FALSE, fig.width=8, fig.height=2}
fig1 <- plot_ly(
...
annotations = list( 
  ...
  list( 
    ...
    xanchor = "center",  
    yanchor = "bottom",  
    showarrow = FALSE ,font = list(size = 24)
  ),
  list( 
    x = 0.5,  
    y = 0.4,  
